...
arrowimages: {down:['downarrowclass', templateUrl+'/assets/images/down_arrow_icon.png', 23], right:['rightarrowclass', templateUrl+'/assets/images/right_arrow_icon.png', 6], left:['leftarrowclass', templateUrl+'/assets/images/left_arrow_icon.png']},
...
$(".navigation ul li").find("ul").parent().addClass("caretIcon");
$(".navigation ul li ul").find("ul").parent().addClass("caretNumber");
...
// $('input[name=orderPrint]').click(function () {
//     if (this.id == "watch-me") {
//         $("#show-me").slideToggle();
//     } else {
//         $("#show-me").slideToggle();
...
switchData.hide();
$('input[type="radio"]').change(function(){ var inputData = $(this).attr("value");if(inputData == 'Order print') { switchData.show();}else{switchData.hide();}});
...
jQuery(function($){
    ...
    $('.carousel-prev').click(function(){ 
        $(this).parent().find('.center').slick('slickPrev');
    } );
    
    $('.carousel-next').click(function(e){
        e.preventDefault(); 
        $(this).parent().find('.center').slick('slickNext');
    } );
});
